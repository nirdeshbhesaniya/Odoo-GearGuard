            ...
            {getPageNumbers().map((page, index) => (
              page === '...' ? (
                ...
                <button
                  ...
                  className={`relative inline-flex items-center px-4 py-2 text-sm font-semibold ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 ${currentPage === page
